...
## Project Structure
    ...
    ├── roulette_fitness_37619  # Django project configurations
...
1. Clone this repo and `cd roulette_fitness_37619`
...
2. Clone this repo and `cd roulette_fitness_37619`
